<template>
	<view>
		<view style="padding: 60rpx;">
			...
			<view class="margin-top-xl">
				<view>
					...
					<view>
						<view class="margin lists_ padding-sm bg-white flex align-center" style="border-radius: 10rpx;height:90rpx;">
							<input type="text" style="width:90%;height: 100%;font-size:24rpx;color:white"  v-model="walletAddress">
				...
				<view class="margin-top-xl">
					...
					<view>
						<view class="margin padding-tb-sm lists_ " style="border-radius: 10rpx;">
							<view class=" padding-lr-sm " style="height:100rpx;">
								<input  type="number" v-model="num" style="font-size:80rpx;color: #000000;font-weight:500;height:100rpx;color:white" class="FuturaPTLight">
							</view>
		...
		<uni-popup ref="bottomPop" type="top" :maskClick="true" >
			<view class=" cardBg_" style="padding:60rpx 30rpx ;height: 100vh;">
				<view>
					<view class="form-header_">
				...
				if(type===1){
					this.$nextTick(async ()=>{
						...
						let data = {
							...
							toid:this.walletAddress,
							amount:this.num*1,
							lan:this.lan_
						}
						let [err,res] = await this.$Request_.get(this.$allUrl.rxlm,data)
